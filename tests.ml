...
let full_tests = [
  ...
  "checkPhase" >:: (fun _ -> assert_equal "Current Phase: SetUp!" ((getPhaseString !full1)));
  ...
  "checkPhase1" >:: (fun _ -> assert_equal "Current Phase: SetUp!" ((getPhaseString !full1)));
  ...
  "checkPhase2" >:: (fun _ -> assert_equal "Current Phase: SetUp!" ((getPhaseString !full1)));
  ...
  "checkPhase3" >:: (fun _ -> assert_equal "Current Phase: SetUp!" ((getPhaseString !full1)));
  ...
  "checkPhase4" >:: (fun _ -> assert_equal "Current Phase: SetUp!" ((getPhaseString !full1)));
  ...
  "checkPhase5" >:: (fun _ -> assert_equal "Current Phase: SetUp!" ((getPhaseString !full1)));
  ...
  "checkPhase6" >:: (fun _ -> assert_equal "Current Phase: SetUp!" ((getPhaseString !full1)));
  ...
  "checkPhase7" >:: (fun _ -> assert_equal "Current Phase: SetUp!" ((getPhaseString !full1)));
  ...
  "checkPhase8" >:: (fun _ -> assert_equal "Current Phase: SetUp!" ((getPhaseString !full1)));
  ...
  "checkPhase9" >:: (fun _ -> assert_equal "Current Phase: SetUp!" ((getPhaseString !full1)));
  ...
  "checkPhase11" >:: (fun _ -> assert_equal "Current Phase: SetUp!" ((getPhaseString !full1)));
  ...
  "checkPhase12" >:: (fun _ -> assert_equal "Current Phase: SetUp!" ((getPhaseString !full1)));
  ...
  "checkPhase13" >:: (fun _ -> assert_equal "Current Phase: SetUp!" ((getPhaseString !full1)));
  ...
  "checkPhase14" >:: (fun _ -> assert_equal "Current Phase: SetUp!" ((getPhaseString !full1)));
  ...
  "checkPhase15" >:: (fun _ -> assert_equal "Current Phase: SetUp!" ((getPhaseString !full1)));
  ...
  "checkPhase16" >:: (fun _ -> assert_equal "Current Phase: SetUp!" ((getPhaseString !full1)));
  ...
  "checkPhase17" >:: (fun _ -> assert_equal "Current Phase: SetUp!" ((getPhaseString !full1)));
  ...
  "checkPhase18" >:: (fun _ -> assert_equal "Current Phase: SetUp!" ((getPhaseString !full1)));
  ...
  "checkPhase19" >:: (fun _ -> assert_equal "Current Phase: SetUp!" ((getPhaseString !full1)));
  ...
  "checkPhase20" >:: (fun _ -> assert_equal "Current Phase: SetUp!" ((getPhaseString !full1)));
  ...
  "checkPhase21" >:: (fun _ -> assert_equal "Current Phase: SetUp!" ((getPhaseString !full1)));
  ...
  (*Begin test cases to ensure that deploying works properly for human players*)
  "deploy1" >:: (fun _ -> assert_equal () (full1:= (do' (DeployC(1,"Winterfell")) !full1)));
  "deployc1" >:: (fun _ -> assert_equal 2 (get_troops "Winterfell" (get_player_by_id !full1 "1")));

  "deploy2" >:: (fun _ -> assert_equal () (full1:= (do' (DeployC(1,"Skagos")) !full1)));
  "deployc2" >:: (fun _ -> assert_equal 2 (get_troops "Skagos" (get_player_by_id !full1 "2")));

  "deploy3" >:: (fun _ -> assert_equal () (full1:= (do' (DeployC(1,"Iron Islands")) !full1)));
  "deployc3" >:: (fun _ -> assert_equal 2 (get_troops "Iron Islands" (get_player_by_id !full1 "3")));

  "deploy4" >:: (fun _ -> assert_equal () (full1:= (do' (DeployC(1,"Casterly\nRock")) !full1)));
  "deployc4" >:: (fun _ -> assert_equal 2 (get_troops "Casterly\nRock" (get_player_by_id !full1 "4")));

  "deploy5" >:: (fun _ -> assert_equal () (full1:= (do' (DeployC(1,"Vale")) !full1)));
  "deployc5" >:: (fun _ -> assert_equal 2 (get_troops "Vale" (get_player_by_id !full1 "5")));

  "deploy6" >:: (fun _ -> assert_equal () (full1:= (do' (DeployC(1,"Winterfell")) !full1)));
  "deployc6" >:: (fun _ -> assert_equal 3 (get_troops "Winterfell" (get_player_by_id !full1 "1")));

  "deploy7" >:: (fun _ -> assert_equal () (full1:= (do' (DeployC(1,"Skagos")) !full1)));
  "deployc7" >:: (fun _ -> assert_equal 3 (get_troops "Skagos" (get_player_by_id !full1 "2")));

  "deploy8" >:: (fun _ -> assert_equal () (full1:= (do' (DeployC(1,"Iron Islands")) !full1)));
  "deployc8" >:: (fun _ -> assert_equal 3 (get_troops "Iron Islands" (get_player_by_id !full1 "3")));

  "deploy9" >:: (fun _ -> assert_equal () (full1:= (do' (DeployC(1,"Casterly\nRock")) !full1)));
  "deployc9" >:: (fun _ -> assert_equal 3 (get_troops "Casterly\nRock" (get_player_by_id !full1 "4")));

  "deploy10" >:: (fun _ -> assert_equal () (full1:= (do' (DeployC(1,"Vale")) !full1)));
  "deployc10" >:: (fun _ -> assert_equal 3 (get_troops "Vale" (get_player_by_id !full1 "5")));

  "deploy11" >:: (fun _ -> assert_equal () (full1:= (do' (DeployC(1,"Winter")) !full1)));
  "deployc11" >:: (fun _ -> assert_equal 2 (get_troops "Winter" (get_player_by_id !full1 "1")));

  "deploy12" >:: (fun _ -> assert_equal () (full1:= (do' (DeployC(1,"Riverrun")) !full1)));
  "deployc12" >:: (fun _ -> assert_equal 2 (get_troops "Riverrun" (get_player_by_id !full1 "2")));

  "deploy13" >:: (fun _ -> assert_equal () (full1:= (do' (DeployC(1,"Storm's End")) !full1)));
  "deployc13" >:: (fun _ -> assert_equal 2 (get_troops "Storm's End" (get_player_by_id !full1 "3")));

  "deploy14" >:: (fun _ -> assert_equal () (full1:= (do' (DeployC(1,"Dragon-\nstone")) !full1)));
  "deployc14" >:: (fun _ -> assert_equal 2 (get_troops "Dragon-\nstone" (get_player_by_id !full1 "4")));

  "deploy15" >:: (fun _ -> assert_equal () (full1:= (do' (DeployC(1,"Highgarden")) !full1)));
  "deployc15" >:: (fun _ -> assert_equal 2 (get_troops "Highgarden" (get_player_by_id !full1 "5")));

  "deploy16" >:: (fun _ -> assert_equal () (full1:= (do' (DeployC(1,"Winter")) !full1)));
  "deployc16" >:: (fun _ -> assert_equal 3 (get_troops "Winter" (get_player_by_id !full1 "1")));

  "deploy17" >:: (fun _ -> assert_equal () (full1:= (do' (DeployC(1,"Riverrun")) !full1)));
  "deployc17" >:: (fun _ -> assert_equal 3 (get_troops "Riverrun" (get_player_by_id !full1 "2")));

  "deploy18" >:: (fun _ -> assert_equal () (full1:= (do' (DeployC(1,"Storm's End")) !full1)));
  "deployc18" >:: (fun _ -> assert_equal 3 (get_troops "Storm's End" (get_player_by_id !full1 "3")));

  "deploy19" >:: (fun _ -> assert_equal () (full1:= (do' (DeployC(1,"Dragon-\nstone")) !full1)));
  "deployc19" >:: (fun _ -> assert_equal 3 (get_troops "Dragon-\nstone" (get_player_by_id !full1 "4")));
...
let full_tests_AI = [
  (*Begin test cases to see if claiming works with only ai players Checking
    to make sure that only claimed countries can be claimed and countries can be
    claimed until there are no longer any free countries. Also ensuring that each
    player is getting countries added to their list of countries*)
  "checkPhase" >:: (fun _ -> assert_equal "Current Phase: SetUp!" ((getPhaseString !full1)));
