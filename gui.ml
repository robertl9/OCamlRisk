...
and draw window cl st =
  ...
  let aDice =
    ...
    | [] ->
      (let a_dice1 = GMisc.image ~file: "images/nodice.png" ~packing:(gameBoard#put ~x:1020 ~y:300) () in
       let a_dice2 = GMisc.image ~file: "images/nodice.png" ~packing:(gameBoard#put ~x:1080 ~y:300) () in
       let a_dice3 = GMisc.image ~file: "images/nodice.png" ~packing:(gameBoard#put ~x:1140 ~y:300) () in ())
    | x::[] ->
      (let a_dice1 = GMisc.image ~file: ("images/dice"^(string_of_int x)^".png") ~packing:(gameBoard#put ~x:1020 ~y:300) () in
      let a_dice2 = GMisc.image ~file: "images/nodice.png" ~packing:(gameBoard#put ~x:1080 ~y:300) () in
       let a_dice3 = GMisc.image ~file: "images/nodice.png" ~packing:(gameBoard#put ~x:1140 ~y:300) () in ())
    | x::x'::[] ->
      (let a_dice1 = GMisc.image ~file: ("images/dice"^(string_of_int x)^".png") ~packing:(gameBoard#put ~x:1020 ~y:300) () in
      let a_dice2 = GMisc.image ~file: ("images/dice"^(string_of_int x')^".png") ~packing:(gameBoard#put ~x:1080 ~y:300) () in
       let a_dice3 = GMisc.image ~file: "images/nodice.png" ~packing:(gameBoard#put ~x:1140 ~y:300) () in ())
    | x::x'::x''::[] ->
      (let a_dice1 = GMisc.image ~file: ("images/dice"^(string_of_int x)^".png") ~packing:(gameBoard#put ~x:1020 ~y:300) () in
      let a_dice2 = GMisc.image ~file: ("images/dice"^(string_of_int x')^".png") ~packing:(gameBoard#put ~x:1080 ~y:300) () in
       let a_dice3 = GMisc.image ~file: ("images/dice"^(string_of_int x'')^".png") ~packing:(gameBoard#put ~x:1140 ~y:300) () in ())
  ...
  let dDice =
    ...
    | [] ->
      (let d_dice1 = GMisc.image ~file: "images/nodice.png" ~packing:(gameBoard#put ~x:1040 ~y:400) () in
       let d_dice2 = GMisc.image ~file: "images/nodice.png" ~packing:(gameBoard#put ~x:1120 ~y:400) () in ())
    | x::[] ->
      (let d_dice1 = GMisc.image ~file: ("images/dice"^(string_of_int x)^".png") ~packing:(gameBoard#put ~x:1040 ~y:400) () in
       let d_dice2 = GMisc.image ~file: "images/nodice.png" ~packing:(gameBoard#put ~x:1120 ~y:400) () in ())
    | x::x'::[] ->
      (let d_dice1 = GMisc.image ~file: ("images/dice"^(string_of_int x)^".png") ~packing:(gameBoard#put ~x:1040 ~y:400) () in
       let d_dice2 = GMisc.image ~file: ("images/dice"^(string_of_int x')^".png") ~packing:(gameBoard#put ~x:1120 ~y:400) () in ())
    | _ -> (failwith "Invalid Roll") in
  let _ = dDice in
...
let selectPlayers p ai aiD r vbox =
